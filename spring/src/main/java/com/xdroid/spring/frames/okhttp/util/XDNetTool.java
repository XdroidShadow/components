package com.xdroid.spring.frames.okhttp.util;
    ...
    public static void isConnected(Context context, CallBack callBack) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.LOLLIPOP) {
                ...
                Log.e("MK_AIS", "网络连接信息 : " + sb.toString());
            ...
            Log.e(TAG, "网络连接状态：" + isConnected + "   信息：" + message);
//            XDDeviceLogManager.storeJson("网络连接状态：" + isConnected + "   信息：" + message);
            ...
            callBack.onUnConnected("网络状态获取失败");
        }
    }
